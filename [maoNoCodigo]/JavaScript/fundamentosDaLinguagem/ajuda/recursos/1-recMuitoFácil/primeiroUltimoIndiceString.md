...
[developer.mozilla.org](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/includes/)
* Determina se um array inclui um determinado valor entre suas entradas, retornando true ou false conforme apropriado.

## # String.prototype.indexOf()
[developer.mozilla.org](https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Reference/Global_Objects/String/indexOf)
* Retorna o índice dentro do objeto String de chamada da primeira ocorrência do valor especificado, iniciando a pesquisa em fromIndex. Retorna -1 se o valor não for encontrado.

## # String.prototype.lastIndexOf()
[developer.mozilla.org](https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Reference/Global_Objects/String/lastIndexOf)
* Retorna o índice dentro do objeto String de chamada da última ocorrência do valor especificado, pesquisando para trás a partir de fromIndex. Retorna -1 se o valor não for encontrado.
