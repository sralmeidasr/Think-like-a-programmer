...
## # Array.prototype.map()
[developer.mozilla.org](https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Reference/Global_Objects/Array/map)
* Cria uma novo array com os resultados da função fornecida em cada elemento do array de chamada.

## # Loops e Iteração
[developer.mozilla.org](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Loops_and_iteration)
* Loops oferecem uma maneira rápida e fácil de fazer algo repetidamente. Este capítulo do Guia JavaScript apresenta as diferentes instruções de iteração disponíveis para JavaScript.
